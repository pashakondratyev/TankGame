...
The score is displayed in the terminal window.
...
Known Bugs:
Can shoot through walls depending on the wall.
Collision detections isn't perfect( it might be a few pixels off and still register as a hit)
